...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240314072510_Initial_migration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveRequest", b =>
                {
                    ...
                    b.Property<string>("RequestingEmloyeeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 3, 14, 10, 25, 10, 55, DateTimeKind.Local).AddTicks(3779),
                            DateModified = new DateTime(2024, 3, 14, 10, 25, 10, 55, DateTimeKind.Local).AddTicks(3797),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
